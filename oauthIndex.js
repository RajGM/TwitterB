...
async function testFetchAndFilter(testID,testTag){
    let testID1 = "1502246747690930178";
    let testTag1 = "bitcoin";
    let tweetArray = await getTweetAndFilter(testID1, testTag1);
    console.log("tweetArray:",tweetArray);
}
